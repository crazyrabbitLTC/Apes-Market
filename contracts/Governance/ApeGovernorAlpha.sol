...
contract GovernorAlpha {
    ...
    function propose(
        ...
        require(
            ...
            "GovernorAlpha::propose: proposal function arity mismatch"
        );
    ...
    function queue(uint256 proposalId) public {
        require(
            ...
            "GovernorAlpha::queue: proposal can only be queued if succeeded"
        );
    ...
    function execute(uint256 proposalId) public payable {
        require(
            ...
            "GovernorAlpha::execute: proposal can only be executed if queued"
        );
        Proposal storage proposal = proposals[proposalId];
    ...
    function __queueSetTimelockPendingAdmin(address newPendingAdmin, uint256 eta) public {
        require(msg.sender == guardian, "GovernorAlpha::__queueSetTimelockPendingAdmin:sender!=guardian");
        timelock.queueTransaction(address(timelock), 0, "setPendingAdmin(address)", abi.encode(newPendingAdmin), eta);
    }

    function __executeSetTimelockPendingAdmin(address newPendingAdmin, uint256 eta) public {
        require(msg.sender == guardian, "GovernorAlpha::__executeSetTimelockPendingAdmin:sender!=guardian");
